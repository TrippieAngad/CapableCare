...
function Map({ children, styles, ...props }: MapProps) {
  ...
  }, [isMounted, mapStyles.dark, mapStyles.light, props, resolvedTheme]);
...
function MapMarker({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      marker.off("drag", handleDragMove);
  ...
  }, [draggable, isLoaded, latitude, longitude, map, onClick, onDrag, onDragEnd, onDragStart, onMouseEnter, onMouseLeave, markerOptions]);
...
function MarkerPopup({
  ...
  }, [isReady, markerRef, popupOptions]);
...
function MarkerTooltip({
  ...
  }, [isReady, map, markerElementRef, markerRef, popupOptions]);
...
function MapPopup({
  ...
  }, [container, latitude, longitude, map, onClose, popupOptions]);
